...
// File @openzeppelin/contracts/utils/math/SafeCast.sol@v4.9.1
...
// File contracts/swap/NineInchSpotLimitPLS.sol
 ...
 */
contract NineInchSpotLimitPLS is ReentrancyGuard, Pausable, Ownable {
    //---------- Libraries ----------//
    ...
    IERC20 private immutable nineInch; //

    //---------- Variables ----------//
    uint256 public creditPrice; // Price of credit in nineInch.
    ...
    address public adminAddress; // Address of the admin who can performKeep.
    ...
    //---------- Constructor ----------//
    constructor() {
        adminAddress = 0xC73896721b68ce58DDe039ef79E37FFf164FD355;
        nineInchRouter = INineInchRouter02(
            0xE8e9b33696581ff785b71E388fD9fF4B51FDac9a
        );
        nineInch = IERC20(0x53cF9ffF6195e201053d3b68BFEd1824090B0272);
        creditPrice = 0.20 ether; // nineInch
        creditTime = 7 days;
        returnCredit = true;
    }
     ...
     */
    modifier onlyAdmin() {
        require(_msgSender() == adminAddress, "Only Node Admin");
        _;
    }
    ...
    /** @notice Show the amount of nineInch needed to buy a credit.
     * @return The amount of nineInch.
     */
    function creditPriceInEth(
        ...
        uint256 ethAmount = nineInchRouter.getAmountsIn(
            nineInchAmount,
            _getPath(address(nineInchRouter.WETH()), address(nineInch))
        )[0];
        return ethAmount;
    }
    ...
    function createOrder(
        ...
        if (credits[_msgSender()] < _credits) {
            ...
            nineInch.transfer(adminAddress, creditPrice.mul(requiredCredits));
    ...
    /**
     * @notice Set the nineInch credit price.
     * @param _creditPrice nineInch credit price.
     */
